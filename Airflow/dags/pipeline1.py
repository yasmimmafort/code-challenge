from Airflow.dags.pipeline_part3 import execute_pipeline
...
def execute_pipeline1():
    ...
    command = 'meltano schedule run pipeline1'
    try:
...
dag = DAG(
    'pipeline1',  # Updated dag_id to match the new file name
    default_args=default_args,
    description='Run pipeline1',
